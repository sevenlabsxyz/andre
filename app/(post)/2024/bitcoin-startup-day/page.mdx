...
<Image
  alt="being a founder sucks -- andre neves"
  src="https://i.imgur.com/oqGrgpD.png"
  className="w-full"
/>
...
<Image
  alt="Work === Life for a founder"
  src="https://i.imgur.com/Cs0bk4i.png"
  className="w-full"
/>
...
<Image
  alt="Francisco Chavarria & Andre Neves"
  src="https://i.imgur.com/XAboGH3.jpeg"
  className="w-full"
/>

<Caption>
  Francisco Chavarria (founder of Yopaki) -
  [@franciscobtc](https://twitter.com/franciscobtc)
</Caption>
...
<Image
  alt="The PlebLab Crew"
  src="https://i.imgur.com/yOH1JGG.jpeg"
  className="w-full"
/>
