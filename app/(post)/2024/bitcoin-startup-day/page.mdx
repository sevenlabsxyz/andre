...
<Image alt="being a founder sucks -- andre neves" src="/images/bitcoin-startup-day-2024/hero.png" className='w-full' />

Earlier this year, I was invited by the great [Car Gonzalez](https://www.youtube.com/watch?v=HAJXTzQ5lEo) to give a keynote presentation at the *Bitcoin Startup Day by PlebLab* in Austin, Texas. The event was put together by [PlebLab](https://pleblab.dev) and [WolfNYC](https://wolfnyc.com) and hosted at the wonderful [Bitcoin Commons](https://www.bitcoincommons.com/) in Downtown Austin.
...
<Image alt="Work === Life for a founder" src="/images/bitcoin-startup-day-2024/no-life.png" className='w-full' />
...
<Image alt="Francisco Chavarria & Andre Neves" src="/images/bitcoin-startup-day-2024/yopaki.jpg" className='w-full' />
...
<Image alt="The PlebLab Crew" src="/images/bitcoin-startup-day-2024/crew.jpg" className='w-full' />
